...
class TrucksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create truck" do
    assert_difference('Truck.count') do
      post trucks_url, params: { truck: { address: @truck.address, name: @truck.name, phone: @truck.phone, website: @truck.website } }
    end
  ...
  test "should update truck" do
    patch truck_url(@truck), params: { truck: { address: @truck.address, name: @truck.name, phone: @truck.phone, website: @truck.website } }
